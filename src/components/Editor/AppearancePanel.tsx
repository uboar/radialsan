...
export const AppearancePanel: React.FC<AppearancePanelProps> = ({ appearance, onChange }) => (
  <div className="space-y-4">
    <h3 className="text-sm font-semibold text-zinc-400 uppercase tracking-wide">Appearance</h3>

    <div className="grid grid-cols-2 gap-3">
      <div>
        <label className="block text-xs text-zinc-400 mb-1">Inner Radius</label>
        <input
          type="range"
          min={10}
          max={100}
        ...
        />
        <span className="text-xs text-zinc-500">{appearance.innerRadius}px</span>
      </div>
      <div>
        <label className="block text-xs text-zinc-400 mb-1">Outer Radius</label>
        <input
          type="range"
          min={60}
          max={300}
          ...
          className="w-full accent-blue-600"
        />
        <span className="text-xs text-zinc-500">{appearance.outerRadius}px</span>
      </div>
    </div>
    ...
    <div className="grid grid-cols-2 gap-3">
      ...
      <div>
        <label className="block text-xs text-zinc-400 mb-1">Slice Fill</label>
        <input
          type="color"
      ...
      <div>
        <label className="block text-xs text-zinc-400 mb-1">Hover Color</label>
        <input
          type="color"
      ...
      <div>
        <label className="block text-xs text-zinc-400 mb-1">Border</label>
        <input
          type="color"
    ...
    <div>
      ...
      <input
        ...
        className="w-full accent-blue-600"
      />
      <span className="text-xs text-zinc-500">{appearance.opacity}</span>
    </div>
    ...
    <div>
      ...
      <input
        ...
        className="w-full accent-blue-600"
      />
      <span className="text-xs text-zinc-500">{appearance.labelSize}px</span>
    </div>
  </div>
);
