...
<nav
  class="flex h-screen w-64 shrink-0 flex-col gap-1 border-r border-theme-border bg-theme-bg-secondary p-5"
>
  <h1
    class="mb-7 truncate px-2 text-xl font-bold leading-tight text-theme-text-primary"
  >
    radialsan
  </h1>
