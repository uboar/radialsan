export type LucideIconElement = 'circle' | 'ellipse' | 'line' | 'path' | 'polygon' | 'polyline' | 'rect';
...
export const LUCIDE_ICON_NAMES = [
  ...
  'Trash2', 'Type', 'Bold', 'Italic', 'Underline',
...
export function getLucideIconNode(iconOrName: string): LucideIconNode | null {
  const name = iconOrName.startsWith('lucide:') ? getLucideIconName(iconOrName) : normalizeLucideIconName(iconOrName);
